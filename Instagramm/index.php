...
<script>
  ...
  gtag('config', 'UA-');
	...
	<meta property="og:url" content="https://adultfriend.site/Instagramm/" /> <!-- URL which is displayed when sharing your site on social networks. -->
	<!-- <meta property="og:image" content="https://adultfriend.site/Instagramm/img/yourimagename.jpg" /> Link to your social-share image. Don't forget to uncomment this line. -->
...
function random(min,max)
	...
	<footer>
		...
		<div id="privacy-policy" class="pp-popup-wrapper popup-wrapper mfp-hide">
			...
			<p><strong>This document was last updated on April 3, 2020</strong></p>
		</div>
